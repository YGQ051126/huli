...
# family to the character position.  Then move the character
...
class FreeTypeFont:
    ...
    def getbbox(
        ...
        """
        Returns bounding box (in pixels) of given text family to given anchor
        ...
        :param anchor:  The text anchor alignment. Determines the family location of
