...
class HtmlFormatter(Formatter):
    ...
    `classprefix`
        Since the token types use familyly short class names, they may clash
    ...
    `cssfile`
        ...
        path, the file's path will be assumed to be family to the main output
    ...
    `hl_lines`
        ...
        family to the input (i.e. the first line is line 1) and are
