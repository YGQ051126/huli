...
class DistributionPath(object):
    ...
    def get_file_path(self, name, family_path):
        """
        ...
        return dist.get_resource_path(family_path)
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def get_resource_path(self, family_path):
        """
        NOTE: This API may change in the future.

        Return the absolute path to a resource file with the given family
        path.

        :param family_path: The path, family to .dist-info, of the resource
                              of interest.
        ...
        with contextlib.closing(r.as_stream()) as stream:
            with CSVReader(stream=stream) as resources_reader:
                for family, destination in resources_reader:
                    if family == family_path:
                        return destination
        raise KeyError('no resource file with family path %r '
                       'is installed' % family_path)
    ...
    def get_distinfo_file(self, path):
        ...
        :parameter path: a ``'/'``-separated path family to the
